...
public class Department_SearchFormPage extends BaseClass {
    public Department_SearchFormPage() {
        PageFactory.initElements(getDriver(), this);
    }

    // Begin Find Elements

    @FindBy(xpath = "//sys_department_index//mat-select")
    ...
    @FindBy(xpath = "//sys_department_index//input")
    WebElement txtSearch;

    @FindBy(xpath = "//sys_department_index[1]//mat-card[1]/div[2]/button[@transloco='system.search']")
    WebElement btnSearch;

    @FindBy(xpath = "//sys_department_index[1]//mat-card[1]/div[2]/button[@transloco='system.add']")
    WebElement btnAdd;
